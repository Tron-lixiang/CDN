...
$packages["github.com/gopherjs/gopherjs/js"] = (function() {
	...
	Object = $pkg.Object = $newType(0, $kindStruct, "js.Object", true, "", true, function(object_) {
		this.$val = this;
	...
	Error = $pkg.Error = $newType(0, $kindStruct, "js.Error", true, "", true, function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
...
$packages["main"] = (function() {
	...
	main = function() {
		...
		$global.document.title = $externalize("Code_Rain-LiXiangPRO", $String);
	...
	$init = function() {
		...
		githubLink = "https://lixiangpro.com";
		level1Cols = 40;
		level2Cols = 60;
		index = 1;
		if ($pkg === $mainPkg) {
